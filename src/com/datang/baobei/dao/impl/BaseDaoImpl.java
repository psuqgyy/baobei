...
import com.datang.baobei.dao.BaseDao;
import com.datang.baobei.util.HibernateHandler;
import com.datang.baobei.util.ObjectUtil;
import com.datang.baobei.util.Pagination;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
	...
	public  List<T> findAll() {
		return sessionFactory.getCurrentSession().createQuery("from " + entityClazz.getSimpleName() + " obj").list();
	}
